...
public class DonViQuanLy {
    ...
    public DonViQuanLy(int id, int khu_vuc_id, String loai_don_vi, String ma_don_vi, String ten_don_vi, double dien_tich, double suc_chua, String trang_thai, Date ngay_tao, Date ngay_cap_nhat) {
        this.id = id;
